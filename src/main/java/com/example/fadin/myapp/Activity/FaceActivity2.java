...
import com.example.fadin.myapp.Util.camera.CameraHelper;
import com.example.fadin.myapp.Util.camera.CameraListener;
import com.example.fadin.myapp.Util.face.ConfigUtil;
import com.example.fadin.myapp.Util.face.DrawHelper;
import com.example.fadin.myapp.Util.widget.FaceRectView;
import com.example.fadin.myapp.model.DrawInfo;
...
public class FaceActivity2 extends AppCompatActivity {
    ...
    private void initEngine() {
        ...
        if (afCode != ErrorInfo.MOK) {
            Toast.makeText(this, "初始化失败，错误码为："+ afCode, Toast.LENGTH_SHORT).show();
        }
    }
