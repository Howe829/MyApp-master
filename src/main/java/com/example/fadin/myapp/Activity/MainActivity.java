...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    //onClick实现跳转到图片检测
    public void jumptoImagetest(final View view)
    {
        Intent intent = new Intent(MainActivity.this, FaceActivity1.class);
        startActivity(intent);
    }


    //onClick实现跳转到预览检测
    public void jumptopreviewtest(final View view)
    {
        Intent intent = new Intent(MainActivity.this, FaceActivity2.class);
        startActivity(intent);
    }
    ...
    //对应ActivityCompat.requestPermissions(this, NEEDED_PERMISSIONS, ACTION_REQUEST_PERMISSIONS);
    @Override
